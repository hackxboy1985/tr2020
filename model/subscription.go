...
// lockForUpdate returns a tx with FOR UPDATE locking clause for PostgreSQL/MySQL.
// SQLite doesn't support FOR UPDATE, but its default behavior is already serialized.
